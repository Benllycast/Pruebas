...
/*
config_acelerometro._MODE_CONTROL_REGISTER = 0b01001001;
config_acelerometro._CONTROL_1 = 0b00000000;
config_acelerometro._CONTROL_2 = 0b00000000;
config_acelerometro._LEVEL_DETECTION_THREHOLDS = 0x01;
config_acelerometro._PULSE_DETECTION_THREHOLDS = 0x01;
config_acelerometro._PULSE_DURATION = 0x00;
config_acelerometro._LANTENCY_TIME = 0x00;
config_acelerometro._TIME_WINDOWS = 0x00;
*/
#use i2c(master, sda=PIN_C4, scl=PIN_C3, FORCE_HW)

void config_MMA();                //setear la cofiguracion incial
void set_config(*CONFIG_MMA7455);
int read_MMA(unsigned int8 start, int8 *buffer,int size);                  //leer datos desde el mma
void write_MMA();                 //escribir datos desde el mma
int1 begin_transmicion(unsigned int8 address);         //seleccion del dispositivo en el bus spi
int1 end_transmicion(bool);
int8 requesFROM(unsigned int8 address);         //deseleccion del dispositivo en el bus spi
#endif
